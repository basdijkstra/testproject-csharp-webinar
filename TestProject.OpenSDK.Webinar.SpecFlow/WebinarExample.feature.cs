...
namespace TestProject.OpenSDK.Webinar.SpecFlow
{
    ...
    [NUnit.Framework.DescriptionAttribute("WebinarExample")]
    public partial class WebinarExampleFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "WebinarExample", "\tIn order to see beautiful SpecFlow reports on TestProject Cloud\r\n\tAs a TestProje" +
        ...
        [NUnit.Framework.TestCaseAttribute("TC001", "Alex", "John Smith", "12345", null)]
        [NUnit.Framework.TestCaseAttribute("TC002", "Bernard", "John Smith", "98765", null)]
        [NUnit.Framework.TestCaseAttribute("TC003", "Claire", "John Smith", "12345", null)]
        public virtual void UserTriesToLogInToTheTestProjectDemoApplication(string testcase_Id, string firstname, string username, string password, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("testcase-id", testcase_Id);
